...
// Brand tokens from Vesspr main app
const BRAND = {
  blue: "#1D9EFF",
  skyBlue: "#7EC8FF",
  skyLight: "#D9EEFF",
...
export function emailShell(o: EmailShellOpts): string {
  const appUrl = process.env.VESSPR_APP_URL || "https://vesspr.ai";
  const cta =
    o.ctaText && o.ctaUrl
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${BRAND.pageBg};">
  <tr><td align="center" style="padding:24px 12px;">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
      <tr><td style="background:${BRAND.gradient};border-radius:20px 20px 0 0;padding:40px 32px 56px;text-align:center;">
